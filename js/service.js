  // Service tabs functionality
    ...
    document.getElementById('privateTourBtn').addEventListener('click', function() {
    ...
    document.getElementById('tourBookingForm').addEventListener('submit', function(e) {
        ...
        // Show confirmation
        document.getElementById('confirmationTitle').textContent = 'Tour Booking Confirmed!';
        document.getElementById('confirmationMessage').textContent = 'Thank you for your booking. We\'ve sent a confirmation to your email.';
    ...
    document.getElementById('privateTourForm').addEventListener('submit', function(e) {
        e.preventDefault();
        // Here you would normally send the data to your server
        document.getElementById('privateTourModal').style.display = 'none';
        
        // Show confirmation
        document.getElementById('confirmationTitle').textContent = 'Inquiry Submitted!';
        document.getElementById('confirmationMessage').textContent = 'Thank you for your private tour inquiry. Our team will contact you within 24 hours to discuss your request.';
        document.getElementById('confirmationModal').style.display = 'block';
    ...
    document.querySelectorAll('.membership-btn').forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            document.getElementById('membershipModalTitle').textContent = `Join ${plan} Membership`;
    ...
    document.querySelectorAll('.event-btn').forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            document.getElementById('eventModalTitle').textContent = `Book ${eventName}`;
